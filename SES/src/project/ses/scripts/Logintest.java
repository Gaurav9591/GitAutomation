...
@Test(priority=78,groups="smoke")
public void Holidays1() throws InterruptedException {
   	test = extent.createTest("Test Script 78", "To verify holiday link");
   	Loginpage lp = new Loginpage(driver);  
   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
   	lp.login(sData, test, driver);
  lp.clickonlogin(test);
	Homepage hp = new Homepage(driver);
	 ...
	 try {
	  		hp.Holidays(test, driver);
	  	   System.out.println("Holiday link is working fine");
	  	   test.log(Status.PASS, "holiday link is working fine");
    	}
  	 catch(Exception e) { 
   System.out.println("Holiday link is not working fine");
  test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
  	 }}

	
	@Test(priority=79,groups="smoke")
	public void Holidays2() throws InterruptedException {
	   	test = extent.createTest("Test Script 79", "To verify edit link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		Homepage hp = new Homepage(driver);
		 ...
		 try {
		  		hp.Holidays(test, driver);
		  		Thread.sleep(1000);
		  	WebElement edit =driver.findElement(By.xpath("//button[contains(@class,'3OtiP')]"));
		  	edit.click();
		  	   System.out.println("Edit link is working fine");
		  	   test.log(Status.PASS, "Edit link is working fine");
	    	}
	  	 catch(Exception e) { 
	   System.out.println("Edit link is not working fine");
	  test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
	  	 }}

	
	@Test(priority=80,groups="smoke")
	public void Holidays3() throws InterruptedException {
	   	test = extent.createTest("Test Script 80", "To verify delete link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
...
try{
  		hp.Holidays(test, driver);
  		Thread.sleep(1000);
  	WebElement delete =driver.findElement(By.xpath("//button[contains(@class,'34Dy4')]"));
  	delete.click();
  	   System.out.println("Delete link is working fine");
  	   test.log(Status.PASS, "Delete link is working fine");
	}
	 catch(Exception e) { 
System.out.println("Delete link is not working fine");
test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
	 }}


	@Test(priority=81,groups="smoke")
	public void Holidays4() throws InterruptedException {
	   	test = extent.createTest("Test Script 81", "To verify NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try{
	  		hp.Holidays(test, driver);
	  		Thread.sleep(1000);
	  	WebElement newholiday =driver.findElement(By.xpath("//button[contains(.,'New Holiday')]"));
	  	newholiday.click();
	  	   System.out.println("Newholiday link is working fine");
	  	   test.log(Status.PASS, "Newholiday link is working fine");
		}
		 catch(Exception e) { 
	System.out.println("Newholiday link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
		 }}


	@Test(priority=82,groups="smoke")
	public void Holidays5() throws InterruptedException {
	   	test = extent.createTest("Test Script 82", "To verify Textboxes under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		Homepage hp = new Homepage(driver);
		try {
		hp.Newholiday(test, driver);
  	   System.out.println("Textboxes under NewHoliday link is working fine");
  	   test.log(Status.PASS, "Textboxes under NewHoliday link is working fine");
	}
	 catch(Exception e) { 
System.out.println("Textboxes under NewHoliday link is not working fine");
test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
	 }}
	
	@Test(priority=83,groups="smoke")
	public void Holidays6() throws InterruptedException {
	   	test = extent.createTest("Test Script 83", "To verify Calender under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
	...
	try {
			...
			WebElement date = driver.findElement(By.xpath("//input[@placeholder='Start date']"));
					date.click();
	  	   System.out.println("Calender under NewHoliday link is working fine");
	  	   test.log(Status.PASS, "Calender under NewHoliday link is working fine");
		}
		 catch(Exception e) { 
	System.out.println("Calender under NewHoliday link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
		 }}
	
	@Test(priority=84,groups="smoke")
	public void Holidays7() throws InterruptedException {
	   	test = extent.createTest("Test Script 84", "To verify dropdown under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.Holidays(test, driver);
			Thread.sleep(1000);
			WebElement dropdown =driver.findElement(By.xpath("//div[@class='Select-placeholder']"));
			Actions Act =new Actions(driver);
			Thread.sleep(1000);
			Act.click(dropdown);
			Act.sendKeys(Keys.ARROW_DOWN);
			Act.sendKeys(Keys.ENTER);
		    Act.build().perform();
	  	   System.out.println("dropdown  under NewHoliday link is working fine");
	  	   test.log(Status.PASS, "dropdown  under NewHoliday link is working fine");
		}
		 catch(Exception e) { 
	System.out.println("dropdown  under NewHoliday link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
		 }}
	
	@Test(priority=85,groups="smoke")
	public void Holidays8() throws InterruptedException {
	   	test = extent.createTest("Test Script 85", "To verify Calender under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
	...
	@Test(priority=86,groups="smoke")
	public void Holidays9() throws InterruptedException {
	   	test = extent.createTest("Test Script 86", "To verify Radio buttons under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.Holidays(test, driver);
			WebElement radio1 = driver.findElement(By.xpath("//div[@class='YSos6']//button[@type='button']"));
					radio1.click();
					Thread.sleep(1000);
					WebElement radio2 =driver.findElement(By.xpath(" //span[contains(text(),'maths')]"));
					radio2.click();
					Thread.sleep(1000);
					WebElement radio3 = driver.findElement(By.xpath("//span[contains(text(),'science')]"));
					radio3.click();
	  	   System.out.println("Radio buttons under NewHoliday link is working fine");
	  	   test.log(Status.PASS, "Radio buttons under NewHoliday link is working fine");
		}
		 catch(Exception e) { 
	System.out.println("Radio buttons under NewHoliday link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
		 }}
	
	@Test(priority=87,groups="smoke")
	public void Holidays100() throws InterruptedException {
	   	test = extent.createTest("Test Script 87", "To verify Radio buttons under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
	...
	@Test(priority=88,groups="smoke")
	public void Holidays10() throws InterruptedException {
	   	test = extent.createTest("Test Script 88", "To verify save button under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			WebElement save = driver.findElement(By.xpath("//span[contains(text(),'Save')]"));
				save.click();
			Thread.sleep(1000);
		WebElement msg = driver.findElement(By.xpath("//span[contains(text(),'Please check the form, there are some invalid input')]"));
			System.out.println(msg.getText());		
			Assert.assertEquals(msg.getText(), "Please check the form, there are some invalid inputs.");			
	  	   System.out.println("save button under NewHoliday link is working fine");
	  	   test.log(Status.PASS, "save button under NewHoliday link is working fine");
		}
		catch(Exception e) {
			 System.out.println("save button under NewHoliday link is not working fine");
		  	   test.log(Status.PASS, "save button under NewHoliday link is  not working fine");
			}}

  @Test(priority=89,groups="smoke")
	public void Holidays11() throws InterruptedException {
	   	test = extent.createTest("Test Script 89", "To verify cancel button under NewHoliday link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			WebElement cancel = driver.findElement(By.xpath("//span[contains(text(),'Cancel')]"));
			cancel.click();
	  	   System.out.println("cancel button under NewHoliday link is working fine");
	  	     System.out.println("############################################################################");
	  	   test.log(Status.PASS, "cancel button under NewHoliday link is working fine");
		}
		catch(Exception e) {
			 System.out.println("cancel button under NewHoliday link is not working fine");
		  	   test.log(Status.PASS, "cancel button under NewHoliday link is  not working fine");
			}}

       @Test(priority=90,groups="smoke")
		public void Applicationparameter1() throws InterruptedException {
		   	test = extent.createTest("Test Script 90", "To verify Apllication Parameter link");
		   	Loginpage lp = new Loginpage(driver);  
		   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
		   	lp.login(sData, test, driver);
		  lp.clickonlogin(test);
			Homepage hp = new Homepage(driver);
			try {
				hp.parameter(test, driver);
		  	   System.out.println("Apllication Parameter link is working fine");
		  	   test.log(Status.PASS, "Apllication Parameter  link is working fine");
			}
			catch(Exception e) {
				 System.out.println("Apllication Parameter link is not working fine");
			  	   test.log(Status.PASS, "Apllication Parameter link is  not working fine");
				}}

        @Test(priority=91,groups="smoke")
		public void Commonparameter1() throws InterruptedException {
		   	test = extent.createTest("Test Script 91", "To verify Common Parameter link");
		   	Loginpage lp = new Loginpage(driver);  
		   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
		   	lp.login(sData, test, driver);
		  lp.clickonlogin(test);
			...
			try {
				hp.parameter(test, driver);
				Thread.sleep(500);
				WebElement commonparameter =driver.findElement(By.xpath("//a[contains(@href,'/configuration/common-parameters')]")) ;
				commonparameter.click();
		  	   System.out.println("Commom Parameter link is working fine");
		  	   test.log(Status.PASS, "Commom Parameter  link is working fine");
			}
			catch(Exception e) {
				 System.out.println("Commom Parameter link is not working fine");
			  	   test.log(Status.PASS, "Commom Parameter link is  not working fine");
				}}


	 @Test(priority=92,groups="smoke")
		public void Commonparameter2() throws InterruptedException {
		   	test = extent.createTest("Test Script 92", "To verify Search box under common parameter");
		   	Loginpage lp = new Loginpage(driver);  
		   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
		   	lp.login(sData, test, driver);
		  lp.clickonlogin(test);
			...
			try {
				...
				searchbox.sendKeys("cou");
		  	   System.out.println("Search box under common parameter link is working fine");
		  	   test.log(Status.PASS, "Search box under common parameterlink is working fine");
			}
			catch(Exception e) {
				 System.out.println("Search box under common parameter link is not working fine");
			  	   test.log(Status.PASS, "Search box under common parameter link is  not working fine");
				}}
				
	@Test(priority=93,groups="smoke")
		public void Commonparameter3() throws InterruptedException {
		   	test = extent.createTest("Test Script 93", "To verify subparameter under common parameter");
		   	Loginpage lp = new Loginpage(driver);  
		   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
		   	lp.login(sData, test, driver);
		  lp.clickonlogin(test);
			...
			try {
				...
				commonparameter.click();
				Thread.sleep(500);
				WebElement subparameter =driver.findElement(By.xpath("//div[contains(@class,'ZQMXN')]//li[1]//div[1]//div[1]")) ;
				Actions act = new Actions(driver);
				act.moveToElement(subparameter).build().perform();
				//act.click();
				subparameter.click();
		  	   System.out.println("subparameter under common parameter link is working fine");
		  	   test.log(Status.PASS, "subparameter under common parameter is working fine");
			}
			catch(Exception e) {
				 System.out.println("subparameter under common parameter link is not working fine");
			  	   test.log(Status.PASS, "subparameter under common parameter link is  not working fine");
				}}

	@Test(priority=94,groups="smoke")
	public void Commonparameter4() throws InterruptedException {
	   	test = extent.createTest("Test Script 94", "To verify save button subparameter under common parameter");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			WebElement save = driver.findElement(By.xpath("//span[contains(text(),'Save')]"));
			save.click();
	  	   System.out.println("save button common parameter link is working fine");
	  	   test.log(Status.PASS, "save button subparameter under common parameter is working fine");
		}
		catch(Exception e) {
			 System.out.println("save button subparameter under common parameter link is not working fine");
		  	   test.log(Status.PASS, "save button subparameter under common parameter link is  not working fine");
			}}
	
	@Test(priority=95,groups="smoke")
	public void Commonparameter5() throws InterruptedException {
	   	test = extent.createTest("Test Script 95", "To verify cancel button subparameter under common parameterr");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			WebElement cancel = driver.findElement(By.xpath("//span[contains(text(),'Cancel')]"));
			cancel.click();
	  	   System.out.println("Cancel button common parameter link is working fine");
	  	   test.log(Status.PASS, "Cancel button subparameter under common parameter is working fine");
		}
		catch(Exception e) {
			 System.out.println("Cancel button subparameter under common parameter link is not working fine");
		  	   test.log(Status.PASS, "Cancel button subparameter under common parameter link is  not working fine");
			}}
	
	@Test(priority=96,groups="smoke")
	public void Commonparameter6() throws InterruptedException {
	   	test = extent.createTest("Test Script 96", "To verify  subparameter text box under common parameter");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			subparameter.click();
			Thread.sleep(500);
			WebElement subparam = driver.findElement(By.xpath("//input[@id='subParam']"));
			subparam.sendKeys("my subparam");
	  	   System.out.println("subparameter text box under common parameter is working fine");
	  	   test.log(Status.PASS, "subparameter text box under common parameter under is working fine");
		}
		catch(Exception e) {
			 System.out.println("subparameter text box under common parameter link is not working fine");
		  	   test.log(Status.PASS, "subparameter text box under common parameter link is  not working fine");
			}}

	@Test(priority=97,groups="smoke")
	public void Classesparameter1() throws InterruptedException {
	   	test = extent.createTest("Test Script 97", "To verify  classes parameter link under application parameter ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.parameter(test, driver);
			WebElement classparam = driver.findElement(By.xpath("//a[contains(@class,'_1nmyc')]"));
					classparam.click();
	  	   System.out.println("classes parameter link under application parameter  is working fine");
	  	   test.log(Status.PASS, "classes parameter link under application parameter  is working fine");
		}
		 catch(Exception e) { 
	System.out.println("classes parameter link under application parameter is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 	
		 }}

	@Test(priority=98,groups="smoke")
	public void Classesparameter2() throws InterruptedException {
	   	test = extent.createTest("Test Script 98", "To verify text boxes under classes parameter link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.parameter(test, driver);
			Thread.sleep(500);
			WebElement classparam = driver.findElement(By.xpath("//a[contains(@href,'/configuration/classes')]"));
					classparam.click();
					Thread.sleep(500);
			WebElement textbox =driver.findElement(By.xpath("//input[contains(@placeholder,'Search')]"));
			textbox.sendKeys("how r you");
	  	   System.out.println(" Text boxes under classes parameter link  is working fine");
	  	   test.log(Status.PASS, " Text boxes under classes parameter link  is working fine");
		}
		 catch(Exception e) { 
	System.out.println(" Text boxes under classes parameter link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
 }}

	@Test(priority=99,groups="smoke")
	public void Classesparameter3() throws InterruptedException {
	   	test = extent.createTest("Test Script 99", "To verify add class under classes parameter link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		Homepage hp = new Homepage(driver);
		try {
			hp.classAddclass(test, driver);
	  	   System.out.println(" Add class under parameter link  is working fine");
	  	   test.log(Status.PASS, " Add class under classes parameter link  is working fine");
		}
		 catch(Exception e) { 
	System.out.println(" Add class under classes parameter link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
	
		 }}
	
	@Test(priority=100,groups="smoke")
	public void Classesparameter4() throws InterruptedException {
	   	test = extent.createTest("Test Script 100", "To verify name text field  under add class ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			name.sendKeys("hello dear");
	  	   System.out.println(" Name text field under parameter link  is working fine");
	  	   test.log(Status.PASS, " Name text field under classes parameter link  is working fine");
		}
		 catch(Exception e) { 
	System.out.println(" Name text field under classes parameter link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
	
		 }}
	
	@Test(priority=101,groups="smoke")
	public void Classesparameter4() throws InterruptedException {
	   	test = extent.createTest("Test Script 101", "To verify type dropdown  under add class ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.classAddclass(test, driver);
			WebElement drop = driver.findElement(By.xpath("//div[contains(@class,'Select-placeholder')]"));
			Actions act = new Actions(driver);
			act.build().perform();
			drop.click();	
	  	   System.out.println(" Type dropdown  under parameter link  is working fine");
	  	   test.log(Status.PASS, " Type dropdown  under classes parameter link  is working fine");
		}
		 catch(Exception e) { 
	System.out.println(" Type dropdown  under classes parameter link is not working fine");
	test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
	
		 }}
	
	@Test(priority=102,groups="smoke")
	public void Classesparameter5() throws InterruptedException {
	   	test = extent.createTest("Test Script 102", "To verify save button under add class ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		save.click();
		Thread.sleep(1000);
		WebElement msg = driver.findElement(By.xpath("//p[contains(@class,'_3mTGE')]"));
		String error = msg.getText();
      Assert.assertEquals(error, "Required");	
      System.out.println("save & validation is working fine");
      test.log(Status.PASS, " save & validation is working fine  ");
	}
@Test(priority=103,groups="smoke")
public void Classesparameter6() throws InterruptedException {
   	test = extent.createTest("Test Script 103", "To verify cancel button under add class ");
   	Loginpage lp = new Loginpage(driver);  
   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
   	lp.login(sData, test, driver);
  lp.clickonlogin(test);
 ...
 try {
	...
	@Test(priority=104,groups="smoke")
	public void Curriculumparameter1() throws InterruptedException {
	   	test = extent.createTest("Test Script 104", "To verify curriculum link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		Homepage hp = new Homepage(driver);
		try {
		hp.curriculum(test, driver);
		 System.out.println("curriculum link  is working fine");
	     test.log(Status.PASS, " curriculum link is working fine  ");
	}
		catch(Exception e) {
			System.out.println("curriculum link is not working fine");
			test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
		}}
	
	@Test(priority=105,groups="smoke")
	public void Curriculumparameter2() throws InterruptedException {
	   	test = extent.createTest("Test Script 105", "To verify academic button under curriculum link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		hp.curriculum(test, driver);
		Thread.sleep(2000);
		WebElement Academic = driver.findElement(By.xpath("//button[contains(@class,'1DYee')]"));
		Academic.click();
		 System.out.println("Academic button under curriculum link  is working fine");
	     test.log(Status.PASS, " Academic button under curriculum link is working fine  ");
	}
		catch(Exception e) {
			System.out.println("Academic button under curriculum link is not working fine");
			test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
		}}
	
	@Test(priority=106,groups="smoke")
	public void Curriculumparameter3() throws InterruptedException {
	   	test = extent.createTest("Test Script 106", "To verify add subject button under curriculum link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.curriculum(test, driver);
			Thread.sleep(4000);
			WebElement Addsubject = driver.findElement(By.xpath("//button[contains(@class,'btn-primary')]"));
			Addsubject.click();
			 System.out.println("Add subject button under curriculum link  is working fine");
		     test.log(Status.PASS, " Add subject button under curriculum link is working fine  ");
		}
			catch(Exception e) {
				System.out.println("Add subject button under curriculum link is not working fine");
				test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
			}}
	
	@Test(priority=107,groups="smoke")
	public void Curriculumparameter4() throws InterruptedException {
	   	test = extent.createTest("Test Script 107", "To verify subcurriculum button under curriculum link ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.curriculum(test, driver);
			Thread.sleep(4000);
	WebElement hover = driver.findElement(By.cssSelector("#root > div > div > section > main > div._8zsji > div > div.ZQMXN > ul > li:nth-child(2) > div"));
	         	Actions act = new Actions(driver);
	         	act.moveToElement(hover);
	         	Thread.sleep(1000);
   WebElement subcurriculum = driver.findElement(By.xpath("//button[contains(@class,'btn-primary')]"));
	    subcurriculum .click();
	    act.build().perform();
			 System.out.println("subcurriculum button under curriculum link  is working fine");
		     test.log(Status.PASS, " subcurriculum  button under curriculum link is working fine  ");
		}
			catch(Exception e) {
				System.out.println("subcurriculum button under curriculum link is not working fine");
				test.log(Status.FAIL, ExceptionUtils.getStackTrace(e)); 
			}}
	
	@Test(priority=108,groups="smoke")
	public void Streams1() throws InterruptedException {
	   	test = extent.createTest("Test Script 108", "To verify streams link under parameter ");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
	...
	try {
		...
		hp.Streams(test, driver);
		 System.out.println("streams link is working fine");
	     test.log(Status.PASS, " streams link is working fine");
	     }
	catch(Exception e) {
		System.out.println("streams link is not working fine");
	     test.log(Status.PASS, " streams link is not working fine");
		}}
	
	@Test(priority=109,groups="smoke")
	public void Streams2() throws InterruptedException {
	   	test = extent.createTest("Test Script 109", "To verify text box under streams link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			Thread.sleep(500);
			WebElement textbox = driver.findElement(By.xpath("//input[contains(@placeholder,'Search')]"));
			textbox.sendKeys("HEllo Dear");
			 System.out.println("Text box  is working fine");
		     test.log(Status.PASS, " Text box is working fine");
		     }
		catch(Exception e) {
			System.out.println("Text box  is not working fine");
		     test.log(Status.PASS, "Text box  is not working fine");
			}}

	@Test(priority=110,groups="smoke")
	public void Streams3() throws InterruptedException {
	   	test = extent.createTest("Test Script 110", "To verify Add stream under streams link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			hp.Streams(test, driver);
			Thread.sleep(500);
			WebElement addstream = driver.findElement(By.xpath("//span[contains(text(),'Add Stream')]"));
			addstream.click();
			 System.out.println("Add stream  is working fine");
		     test.log(Status.PASS, " Add stream is working fine");
		     }
		catch(Exception e) {
			System.out.println("Add stream  is not working fine");
		     test.log(Status.PASS, "Add stream  is not working fine");
			}}
			
	@Test(priority=111,groups="smoke")
	public void Streams4() throws InterruptedException {
	   	test = extent.createTest("Test Script 111", "To verify Select subject under streams link");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			addstream.click();
			Thread.sleep(2000);
			WebElement selectsubject = driver.findElement(By.xpath("//span[contains(text(),'Select subjects')]"));
			selectsubject.click();
			 System.out.println("Select subject  is working fine");
		     test.log(Status.PASS, " Select subject is working fine");
		     }
		catch(Exception e) {
			System.out.println("Select subject  is not working fine");
		     test.log(Status.PASS, "Select subject  is not working fine");
			}}
	
	@Test(priority=112,groups="smoke")
	public void Streams5() throws InterruptedException {
	   	test = extent.createTest("Test Script 112", "To verify Academic and non academic tab under select subject");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		Homepage hp = new Homepage(driver);
		try {
			hp.selectsubject(test, driver);
			 System.out.println("Academic and non academic tab   is working fine");
		     test.log(Status.PASS, " Academic and non academic tab  is working fine");
		     }
		catch(Exception e) {
			System.out.println("Academic and non academic tab is not working fine");
		     test.log(Status.PASS, "Academic and non academic tab is not working fine");
			}}
	*/
	
	@Test(priority=113,groups="smoke")
	public void Streams6() throws InterruptedException {
	   	test = extent.createTest("Test Script 113", "To verify save & cancel under add stream");
	   	Loginpage lp = new Loginpage(driver);  
	   	String[] sData = ExcelUtils.toReadExcelData("sheet1", "TC-1");
	   	lp.login(sData, test, driver);
	  lp.clickonlogin(test);
		...
		try {
			...
			WebElement cancel = driver.findElement(By.xpath("//span[contains(text(),'Cancel')]"));
			cancel.click();
			 System.out.println("save & cancel tab  is working fine");
		     test.log(Status.PASS, " save & cancel tab  is working fine");
		     }
		catch(Exception e) {
			System.out.println("save & cancel tab is not working fine");
		     test.log(Status.PASS, "save & cancel tab is not working fine");
			}}
