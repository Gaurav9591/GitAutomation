...
public class Homepage<explicitWaitForClickable, managecuriculum> extends WaitStatementLib {
	...
	@FindBy(xpath="//button[contains(.,'New Holiday')]")
	WebElement newholiday;
	...
	@FindBy(xpath="//span[contains(text(),'Application Parameters')]")
	WebElement parameter;
	
	@FindBy(xpath="//a[contains(@href,'/configuration/classes')]")
	WebElement classparameter;
	
	@FindBy(xpath="//span[contains(text(),'Add Class')]")
	WebElement addclass;
	
	@FindBy(xpath="//a[contains(@href,'/configuration/curriculum')]")
	WebElement cuuriculum;
	
	@FindBy(xpath="//a[contains(@href,'/configuration/streams')]")
	WebElement streams;
	
	@FindBy(xpath="//span[contains(text(),'Select subjects')]")
	...
	@FindBy(xpath="//span[contains(text(),'Non-academic')]")
	WebElement nonacademic;
	
	@FindBy(xpath="//span[contains(text(),'Add Stream')]")
...
public String Holidays(ExtentTest test,WebDriver driver) throws InterruptedException {
	configurationlink.click();
	Thread.sleep(1000);
	holidays.click();
	Thread.sleep(1000);
	newholiday.click();
	String msg = holidays.getText();
	return msg;
}

public String Newholiday(ExtentTest test,WebDriver driver) throws InterruptedException {
	configurationlink.click();
	Thread.sleep(1000);
	holidays.click();
	Thread.sleep(1000);
  ...
  public String parameter(ExtentTest test,WebDriver driver) throws InterruptedException {
	  
		configurationlink.click();
		Thread.sleep(1000);
		parameter.click();
		String msg = parameter.getText();
		return msg;
	   }
 public String classAddclass(ExtentTest test,WebDriver driver) throws InterruptedException {
	 configurationlink.click();
		Thread.sleep(1000);
		parameter.click();
		Thread.sleep(500);
		classparameter.click();
		Thread.sleep(500);
		addclass.click();
		String msg = parameter.getText();
		return msg;
 ...
 public String curriculum(ExtentTest test,WebDriver driver) throws InterruptedException {
	 configurationlink.click();
		Thread.sleep(1000);
		parameter.click();
		Thread.sleep(500);
		cuuriculum.click();
		String msg = cuuriculum.getText();
		return msg;
	 }
	  
 public String Streams(ExtentTest test,WebDriver driver) throws InterruptedException {
	 ...
	 configurationlink.click();
		...
		Thread.sleep(1000);
	 streams.click();
	 String msg = streams.getText();
		return msg;
	 }
	
 public String selectsubject(ExtentTest test,WebDriver driver) throws InterruptedException {
